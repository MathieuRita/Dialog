...
def dump_sender_receiver_dialog_model_6(game: torch.nn.Module,
    ...
    with torch.no_grad():
        for batch in dataset:
            ...
            output_12 = game.agent_2.receive(message_1, receiver_input)
            output_11 = game.agent_1.receive(message_1, receiver_input)
            output_21 = game.agent_1.receive(message_2, receiver_input)
            output_22 = game.agent_2.receive(message_2, receiver_input)
