...
class TrainerDialogMultiAgentIdentique:
    """
    Implements the training logic. Some common configuration (checkpointing frequency, path, validation frequency)
    is done by checking util.common_opts that is set via the CL.
    """
...
class TrainerDialogMultiAgentPair:
    """
    Implements the training logic. Some common configuration (checkpointing frequency, path, validation frequency)
    is done by checking util.common_opts that is set via the CL.
    """
    ...
    def train_epoch(self,pair,grad_update):
        mean_loss = 0
        mean_rest = {}
        n_batches = 0
        self.game.train()
    ...
    def train(self, pair,grad_update,n_epochs):
        ...
        for epoch in range(self.start_epoch, n_epochs):
            ...
            train_loss, train_rest = self.train_epoch(pair=pair,grad_update=grad_update)
...
class TrainerDialogMultiAgentPretraining:
    """
    Implements the training logic. Some common configuration (checkpointing frequency, path, validation frequency)
    is done by checking util.common_opts that is set via the CL.
    """
    ...
    def train_epoch(self,pretraining):
        mean_loss = 0
        mean_rest = {}
        n_batches = 0
        self.game.train()
    ...
    def train(self, n_epochs, pretraining=False):
        ...
        for epoch in range(self.start_epoch, n_epochs):
            ...
            train_loss, train_rest = self.train_epoch(pretraining=pretraining)
